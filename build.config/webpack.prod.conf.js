...
var webpackConfig = merge(baseWebpackConfig, {
  ...
  plugins: [
    ...
    new CopyWebpackPlugin([
      ...
      // { from: path.join(__dirname, '../node_modules/obigo-js-ui-rnbs-' + carModel + '/') + '*.css', to: './' + carModel + '/', flatten: true},
      // { from: path.join(__dirname, '../node_modules/obigo-js-ui-rnbs-' + carModel + '/icon/') + '*.*', to: './' + carModel + '/icon', flatten: true},
      // { from: path.join(__dirname, '../node_modules/obigo-js-ui-rnbs-' + carModel + '/font/') + '*.*', to: './' + carModel + '/font', flatten: true}
    ]),
    ...
    new WebpackOnBuildPlugin((stats) => { // build 완료 후 hook
      ...
      // var script = '<link rel=\'stylesheet\' href=\'./' + carModel + '/index.css\'></link>'
